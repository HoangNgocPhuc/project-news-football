<?php 
	...
	$parent_photo = fetch_one("select pk_category_news_parent_id from tbl_category_news_parent where c_name='photos'");
	...
	$arr = fetch("select * from tbl_news where pk_news_id IN ( '" . implode($arr_num, "', '") . "' ) order by pk_news_id desc limit 0,3");
	include "view/view_form_photo.php";
?>